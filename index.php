    ...
    <div class="container">
        <div class="hero__item set-bg" data-setbg="img/hero/banner.jpg">
            <div class="hero__text">
                <h2>EVERYTHING <br /> YOU NEED <br /> IN ONE PLACE</h2>
        ...
        <div class="container">
            <div class="row">
                <div class="categories__slider owl-carousel">
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/item/oranges.jpg">
                            <h5><a href="#">Fresh Fruit</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/item/low-fat-milk.png">
                            <h5><a href="#">Dairy</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/item/cauliflower.jpg">
                            <h5><a href="#">Vegetables</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/item/hausboom-lemonade.jpg">
                            <h5><a href="#">Beverges</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/item/meat.jpg">
                            <h5><a href="#">Fresh Meat</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/item/floor-cleaner.jpg">
                            <h5><a href="#">Cleaning Supplies</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/item/panadol.jpg">
                            <h5><a href="#">Health Care</a></h5>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="featured__controls">
                        <ul>
                            ...
                            <li data-filter=".oranges">Fresh Fruit</li>
